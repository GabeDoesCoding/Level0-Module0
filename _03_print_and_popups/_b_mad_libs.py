...
if __name__ == '__main__':
    ...
    adj = simpledialog.askstring(title='MadLibs', prompt="Type an adjective")
    # Get the player to enter a type of liquid
    liq = simpledialog.askstring(title='MadLibs', prompt="Type a liquid")
    # Get the player to enter a body part
    bod = simpledialog.askstring(title='MadLibs', prompt="Type a body part")
    # Get the player to enter a verb
    ver = simpledialog.askstring(title='MadLibs', prompt="Type a verb")
    # Get the player to enter a place
    pla = simpledialog.askstring(title='MadLibs', prompt="Type a place")
    ...
    story = (
        ...
        "likely take a bite out of your " + bod + " if you " + ver + ".Whatever\n"
    ...
    messagebox.showinfo(title='MadLibs', message=story)
